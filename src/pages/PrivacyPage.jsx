...
const SECTIONS = [
  ...
  { icon: 'fa-brain', color: 'text-purple-400', bg: 'bg-purple-500/10', title: 'AI Synthesis Protocols', span: 1, body: (<>Intelligence briefings generated utilize <strong className="text-white">stateless LLM orchestration (Amazon Bedrock)</strong>. No user input or personally identifiable information (PII) is utilized as context for neural synthesis.</>) },
